...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.VwCourseStudents", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Course", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.CourseInstructor", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Models.Course", "Course")
                    ...
                    b.HasOne("week1Homework_LinChin.Models.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("week1Homework_LinChin.Models.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Models.OfficeAssignment", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("week1Homework_LinChin.Models.Models.OfficeAssignment", "InstructorId")
