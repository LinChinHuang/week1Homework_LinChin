...
namespace week1Homework_LinChin.Migrations
{
    ...
    [Migration("20201208113105_AllowDateModifiedIsNull")]
    partial class AllowDateModifiedIsNull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.VwCourseStudents", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Course", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.CourseInstructor", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Course", "Course")
                    ...
                    b.HasOne("week1Homework_LinChin.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("week1Homework_LinChin.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("week1Homework_LinChin.Models.OfficeAssignment", b =>
                {
                    b.HasOne("week1Homework_LinChin.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("week1Homework_LinChin.Models.OfficeAssignment", "InstructorId")
